...
public class DFBnB {
    ...
    public static Comparator<Node> f_Comparator = new Comparator<Node>() {   //Creating a comparator for sorting the nodes in the neighbors list (according to the f value of each node, increasing order)
        @Override
